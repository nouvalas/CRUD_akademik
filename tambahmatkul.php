...
<div class="container">
    ...
    if ($_SERVER["REQUEST_METHOD"] == "POST") {
        ...
        $sql="insert into t_matkul (kd_matkul,nama_matkul) values
    ('$kd_matkul','$nama_matkul')";
    ...
    <form action="<?php echo $_SERVER["PHP_SELF"];?>" method="post">
        ...
        <div class="form-group">
            ...
            <input type="text" name="nama_matkul" class="form-control" placeholder="Masukan Nama Mata Kuliah" required/>
